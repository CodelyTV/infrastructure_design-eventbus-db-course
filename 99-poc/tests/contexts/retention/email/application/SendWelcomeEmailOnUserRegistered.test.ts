import { SendWelcomeEmailOnUserRegistered } from "../../../../../src/contexts/retention/email/application/send-welcome-email/SendWelcomeEmailOnUserRegistered";
...
describe("SendWelcomeEmailOnUserRegistered should", () => {
	...
	it("send a welcome email on user registered", async () => {
		...
		const expectedDomainEvent = WelcomeEmailSentDomainEventMother.create(
			expectedEmailPrimitives,
		);
